...
class SolrResponseReader:
    def __init__(self, response: Type[requests.Response]):
    ...
    def _construct_thumbnail_url(self, url: str) -> str:
...
def get_bpl_sierra_bib_data(sbids: List[int]) -> Type[namedtuple]:
    """
